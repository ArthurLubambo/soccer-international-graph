// FIFA's 211 member associations, using names as they appear in results.csv
export const FIFA_MEMBERS = new Set([
  // UEFA (55)
  ...
  'Republic of Ireland', 'Israel', 'Italy', 'Kazakhstan', 'Kosovo', 'Latvia',
  ...
  'Cambodia', 'China', 'Taiwan', 'Guam', 'Hong Kong', 'India', 'Indonesia',
  'Iran', 'Iraq', 'Japan', 'Jordan', 'Kuwait', 'Kyrgyzstan', 'Laos',
